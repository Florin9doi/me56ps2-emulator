...
// ── Modem model descriptor data ──────────────────────────────────────────────

// Language descriptor (shared)
...
const struct modem_config modem_me56ps2 = {
    .model_name = "me56ps2",
    .device_descriptor = {
...
const struct modem_config modem_ms56kps2 = {
    .model_name = "ms56kps2",
    .device_descriptor = {
        .bLength            = USB_DT_DEVICE_SIZE,
        .bDescriptorType    = USB_DT_DEVICE,
        ...
        .bDeviceProtocol    = 0,
        .bMaxPacketSize0    = MAX_PACKET_SIZE_CONTROL,
        .idVendor           = __constant_cpu_to_le16(0x05dbU), // Digi International (OnlineStation)
        .idProduct          = __constant_cpu_to_le16(0x0006U), // MS56KPS2
        .bcdDevice          = __constant_cpu_to_le16(BCD_DEVICE),
        .iManufacturer      = STRING_ID_MANUFACTURER,
        .iProduct           = STRING_ID_PRODUCT,
        .iSerialNumber      = STRING_ID_SERIAL,
...
static const struct _usb_string_descriptor<14> p2gate_str_serial = {
    .bLength = sizeof(p2gate_str_serial),
    .bDescriptorType = USB_DT_STRING,
    .wData = {u'S', u'C', u'M', u'U', u'S', u'B', u'2', u'0', u'0', u'0', u'0', u'9', u'7', u'3'},
};
static const struct _usb_string_descriptor<27> p2gate_str_config = {
    .bLength = sizeof(p2gate_str_config),
    .bDescriptorType = USB_DT_STRING,
    .wData = {u'C', u'o', u'n', u'f', u'i', u'g', u'u', u'r', u'a', u't', u'i', u'o', u'n', u' ', u'f', u'o', u'r', u' ', u'H', u'C', u'F', u' ', u'm', u'o', u'd', u'e', u'm'},
};
static const struct _usb_string_descriptor<28> p2gate_str_interface = {
    .bLength = sizeof(p2gate_str_interface),
    .bDescriptorType = USB_DT_STRING,
...
static const struct modem_config *current_config = &modem_me56ps2;
...
bool process_control_packet(usb_raw_gadget *usb, usb_raw_control_event *e, struct usb_packet_control *pkt)
{
    if (e->is_event(USB_TYPE_STANDARD, USB_REQ_GET_DESCRIPTOR)) {
        ...
        if (descriptor_type == USB_DT_STRING) {
            ...
            if (id >= current_config->string_descriptors_num) {return false;} // invalid string id
