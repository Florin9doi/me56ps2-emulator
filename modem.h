...
public:
    ...
    virtual bool handle_set_configuration(struct usb_packet_control *pkt);
    virtual bool handle_vendor_request(usb_raw_control_event *e, struct usb_packet_control *pkt);
